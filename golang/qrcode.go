...
func main() {
  outFile := flag.String("o", "qrcode", "out PNG file prefix, empty for stdout")
  size := flag.Int("s", 1024, "image size (pixel)")
...
Usage:
  1. Arguments except for flags are joined by " " and used to generate QR code.
     Default output is "qrcode.png".

       qrcode "homepage: https://github.com/skip2/go-qrcode"
